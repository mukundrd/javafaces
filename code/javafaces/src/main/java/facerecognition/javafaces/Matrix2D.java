...
public class Matrix2D extends DenseDoubleMatrix2D {
    ...
    public void replaceRowsWithArray(double[] data) {
        if (this.columns != data.length)
            throw new RuntimeException("matrix columns not matching number of input array elements");
    ...
    /***
     * Instance of Matrix2D class cannot be put as element in HashList or as a
     * key in HashMap In the colt library,cern.colt.matrix.DoubleMatrix2D
     * defines equals and uses Object.hashCode() This is not a good idea since
     * Object.hashCode() returns JVM assigned integer.
     */
